...
library(wordcloud2)
sessionInfo()
palette <- c("#999999", "#E69F00", "#009E73", "#0072B2", "#D55E00", "#CC79A7","#AC3E31")
...
```{r,fig.align='center'}
# Interesting: daily rate, education,  job satisfaction,number of companies worked, performance rating,years at company, years with current manager
#Avoid:Age, Gender, marital status, relationship statisfaction, total working years
...
labs(title="Employees", x = "", y="Count", fill="Status") +geom_bar(stat = "count") +
  scale_fill_manual(values=c("#E69F00","#AC3E31"))
...
```{r,fig.align='center'}
ggplot(CaseStudy2_data, aes(x=DailyRate, fill = factor(Attrition)))+
geom_histogram(binwidth=50, color="white") +
  scale_fill_manual(values = c("#009E73","#0072B2"))
#if there is time categorize dailyrate
ggplot(CaseStudy2_data, aes(x=NumCompaniesWorked,fill = factor(Attrition)))+
