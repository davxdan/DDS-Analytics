...
#Orange="#E69F00",Green="#009E73",Blue="#0072B2",DrkOran="#D55E00",Pink="#CC79A7", red="#AC3E31"
...
```{r}
ggplot(CaseStudy2_data, aes(x=Age, y=DailyRate)) + geom_point()

ggplot(CaseStudy2_data, aes(x=Age, y=DailyRate)) +
