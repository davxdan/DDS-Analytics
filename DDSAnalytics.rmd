...
```
```{r}
AgevsIncome.lm<-lm(DailyRate~Age,data = CaseStudy2_data)
#qt(0.995, 198)
#abs(qt(0.01/2, 198))
...
```{r}
# This site has some variable selection methods https://cran.r-project.org/web/packages/olsrr/vignettes/variable_selection.html
